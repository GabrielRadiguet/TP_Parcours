...
- **Standard C++** : Le projet utilise C++20 ou C++23 pour bénéficier de la constante `std::numbers::pi` dans la librairie `<numbers>`
...
- **Auteurs** : Gabriel Radiguet, Baptiste Roy, Matisse Guibert, Eliot Corbonnois, Amen-Allah Bouni